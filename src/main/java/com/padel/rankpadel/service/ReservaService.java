...
public class ReservaService {
    ...
    public Optional<Reserva> crearParaTurnoFijo(TurnoFijo turnoFijo, LocalDate fecha, LocalTime horaInicio,
        ...
        Reserva reserva = Reserva.builder()
                ...
                .horaFin(horaFin)
                .precioAplicado(precio != null ? precio : disponibilidadCanchaService.precioSlot(cancha, fecha, horaInicio))
    ...
    private Reserva crearReserva(Cancha cancha, LocalDate fecha, LocalTime horaInicio,
        ...
        Reserva reserva = Reserva.builder()
                ...
                .horaInicio(horaInicio)
                .horaFin(horaFin)
                .precioAplicado(disponibilidadCanchaService.precioSlot(cancha, fecha, horaInicio))
